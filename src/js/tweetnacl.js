...
function s() {
    (function (e) {
        ...
        function x(e, t, n, r, o) {
            ...
            if (
                n < 32 ||
                (L(i, 0, 32, r, o), T(t, 16, t, 32, n - 32, i) !== 0)
            ) {
                return -1;
            }
            E(e, 0, t, 0, n, r, o);
        ...
        e.secretbox.open = function (e, t, n) {
            ...
            if (r.length < 32 || x(o, r, r.length, t, n) !== 0) {
                return null;
            } else {
                return o.subarray(fe);
            }
        };
        ...
        e.sign.detached = function (t, n) {
            var r = e.sign(t, n);
            for (var o = new Uint8Array(Ee), a = 0; a < o.length; a++) {
                o[a] = r[a];
            }
            return o;
        };
        e.sign.detached.verify = function (e, t, n) {
            ...
            var o = new Uint8Array(Ee + e.length);
            var a;
            for (a = 0; a < Ee; a++) {
                r[a] = t[a];
            }
